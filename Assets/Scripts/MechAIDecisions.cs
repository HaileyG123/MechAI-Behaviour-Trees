...
public class MechAIDecisions : MechAI {
    ...
    private void Swivel()
    {
        ...
        mechAIAiming.body.transform.rotation = Quaternion.Slerp(mechAIAiming.body.transform.rotation, 
            patrolPoints[patrolIndex].transform.rotation * Quaternion.Euler(mechAIAiming.rotOffSet), mechAIAiming.rotSpeed * Time.deltaTime);
    }
}
